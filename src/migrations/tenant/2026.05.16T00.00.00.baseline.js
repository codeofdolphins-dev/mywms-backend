...
export async function down({ context: queryInterface }) {
    const transaction = await queryInterface.sequelize.transaction();
    try {
        await queryInterface.dropTable('ProductionReceipts', { transaction });
        await queryInterface.dropTable('ProductionOrderItems', { transaction });
        await queryInterface.dropTable('TransferOrderAllocations', { transaction });
        await queryInterface.dropTable('TransferOrderItems', { transaction });
        await queryInterface.dropTable('OutwardAllocations', { transaction });
        await queryInterface.dropTable('OutwardItems', { transaction });
        await queryInterface.dropTable('GRNItemBatches', { transaction });
        await queryInterface.dropTable('PurchaseOrderItems', { transaction });
        await queryInterface.dropTable('ProductionOrders', { transaction });
        await queryInterface.dropTable('TransferOrders', { transaction });
        await queryInterface.dropTable('Outwards', { transaction });
        await queryInterface.dropTable('GRNItems', { transaction });
        await queryInterface.dropTable('SalesOrderItems', { transaction });
        await queryInterface.dropTable('PurchasOrders', { transaction });
        await queryInterface.dropTable('RequisitionSuppliers', { transaction });
        await queryInterface.dropTable('QuotationItems', { transaction });
        await queryInterface.dropTable('GRNs', { transaction });
        await queryInterface.dropTable('SalesOrders', { transaction });
        await queryInterface.dropTable('Quotations', { transaction });
        await queryInterface.dropTable('BOMItems', { transaction });
        await queryInterface.dropTable('BOMs', { transaction });
        await queryInterface.dropTable('NodeStockLedgerItems', { transaction });
        await queryInterface.dropTable('RequisitionItems', { transaction });
        await queryInterface.dropTable('NodeStockLedgers', { transaction });
        await queryInterface.dropTable('Requisitions', { transaction });
        await queryInterface.dropTable('CategoryProducts', { transaction });
        await queryInterface.dropTable('Batches', { transaction });
        await queryInterface.dropTable('Products', { transaction });
        await queryInterface.dropTable('NodeDetails', { transaction });
        await queryInterface.dropTable('NodeUsers', { transaction });
        await queryInterface.dropTable('ManufacturingUnits', { transaction });
        await queryInterface.dropTable('Brands', { transaction });
        await queryInterface.dropTable('BusinessNodes', { transaction });
        await queryInterface.dropTable('Vendors', { transaction });
        await queryInterface.dropTable('TenantBusinessFlows', { transaction });
        await queryInterface.dropTable('UserRoles', { transaction });
        await queryInterface.dropTable('Users', { transaction });
        await queryInterface.dropTable('RolePermissions', { transaction });
        await queryInterface.dropTable('HSNs', { transaction });
        await queryInterface.dropTable('RequisitionCategories', { transaction });
        await queryInterface.dropTable('BusinessNodeTypes', { transaction });
        await queryInterface.dropTable('PackageTypes', { transaction });
        await queryInterface.dropTable('UnitTypes', { transaction });
