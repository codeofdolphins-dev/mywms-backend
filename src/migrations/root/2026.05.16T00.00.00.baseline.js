...
export async function down({ context: queryInterface }) {
    const transaction = await queryInterface.sequelize.transaction();
    try {
        await queryInterface.dropTable('RfqQuotationItems', { transaction });
        await queryInterface.dropTable('ProductMappings', { transaction });
        await queryInterface.dropTable('BpoIndentItems', { transaction });
        await queryInterface.dropTable('BpoIndents', { transaction });
        await queryInterface.dropTable('BlanketOrderItems', { transaction });
        await queryInterface.dropTable('BlanketOrders', { transaction });
        await queryInterface.dropTable('RfqQuotationRevisions', { transaction });
        await queryInterface.dropTable('RfqQuotations', { transaction });
        await queryInterface.dropTable('RFQItems', { transaction });
        await queryInterface.dropTable('RFQs', { transaction });
        await queryInterface.dropTable('TenantBusinessFlowMasters', { transaction });
        await queryInterface.dropTable('BusinessNodeTypes', { transaction });
        await queryInterface.dropTable('Tenants', { transaction });
        await queryInterface.dropTable('TenantsNames', { transaction });
