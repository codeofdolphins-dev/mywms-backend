...
import { allMfgNodes, allRegisteredNodes, deleteNode, tenantBusinessNodeList } from "../controllers/businessNode.controller.js";
...
router.route("/delete/:id").delete(verifyPermission("location:delete"), deleteNode);
