...
import { allPurchasOrderList, createPurchasOrder, deletePurchasOrder, purchasOrderItemDetails, updatePurchasOrder, updatePurchasOrderItem } from "../controllers/purchasOrder.controller.js";

const router = Router();

router.use(verifyJWT);

router.route("/list").get(verifyPermission("purchaseOrder:read"), allPurchasOrderList);
router.route("/item-details").get(verifyPermission("purchaseOrder:read"), purchasOrderItemDetails);
